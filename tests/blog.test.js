...
const listWithOneBlogFormatted = {
...
describe('favorite blog', () => {
    ...
    test('out of empty blog list is empty object', () => {
    ...
    test('of a list with a single blog is that blog', () => {
        ...
        expect(listHelper.favoriteBlog(listWithOneBlog)).toEqual(listWithOneBlogFormatted)
    })

    test('out of multiple blogs', () => {
